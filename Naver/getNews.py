...
class getNews:
    ...
    def NewsDetail(self, result, newsList):
        ...
        temp = DataFrame({'title' :title,'text':text,'wDate':wDate,'name':name,'emails':emails,'Media': Media,'area' :area,'grades' : grades,'gain1':gain1,'gain2':gain2,'gain3':gain3,'gain4':gain4,'gain5':gain5,'rank':rank,'comment' :comment,'male':male,'female':female,'age1':age1,'age2':age2,'age3': age3,'age4' :age4,'age5' : age5, 'comments' : comments},
                         columns=['title', 'text', 'wDate', 'name', 'emails', 'Media', 'area', 'grades', 'gain1', 'gain2', 'gain3',
                 'gain4', 'gain5', 'rank', 'comment', 'male', 'female', 'age1', 'age2', 'age3', 'age4', 'age5', 'comments'])
